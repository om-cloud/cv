...
let isKingRegularMove;
let regularMovementKingCount = 0;
...
function countRegularKingMoves(){
  if (isLegalMovement && isKingRegularMove == true && isForcedJump == false && isGameOver == false && isExtraForcedJump == false && isToolTaken == false){
    regularMovementKingCount++;
  }
  else {
    regularMovementKingCount  = 0;
  }
  if (regularMovementKingCount == 15){
    document.getElementById("lastLine").innerText = "15 Sequential Regular King Moves - Tie !!";
  }
}
